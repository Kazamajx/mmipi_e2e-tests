Feature: Inflaction and cost of living KPI on the Insights module

  @tc:19244
    Scenario Outline: I want to see Inflaction and cost of living KPI on the MMI Public Insights website
        ...
        Examples:
            ...
            | "/uk" | "bir"  | "Quick service" | "Breakfast, lunch and dinner" | "Inflaction and cost of living"   |

  @tc:19245
    Scenario Outline: I want to see the accordion expanded Inflaction and cost of living KPI
        Given I open the <url> url
        When I accept the one trust cookies
        When I type <filter> filters on the location textbox on <url> url
        When I click on the first field of the location dropdown menu on <url> url and <filter> filter
  ...
  @tc:19246
    Scenario Outline: I want to click on the Yes or No buttons on the Inflaction and cost of living KPI
        Given I open the <url> url
        When I accept the one trust cookies
        When I type <filter> filters on the location textbox on <url> url
        When I click on the first field of the location dropdown menu on <url> url and <filter> filter
        ...
        Examples:
            ...
            | "/uk" | "bir"  | "Quick service" | "Breakfast, lunch and dinner" | "Inflaction and cost of living" | "Yes"       |
            | "/uk" | "bir"  | "Quick service" | "Breakfast, lunch and dinner" | "Inflaction and cost of living" | "No"        |