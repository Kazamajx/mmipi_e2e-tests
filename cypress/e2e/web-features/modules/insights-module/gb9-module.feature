Feature: Weekly spend KPI on the Insights module

  @tc:19238
    Scenario Outline: I want to see Weekly spend KPI on the MMI Public Insights website
        ...
        Examples:
            ...
            | "/uk" | "bir"  | "Quick service" | "Breakfast, lunch and dinner" | "Weekly spend" |
  ...
  @tc:19239
    Scenario Outline: I want to see the correct data on the Price category module
        ...
        Examples:
            ...
            | "/uk" | "bir"  | "Quick service" | "24/7"                | "Weekly spend" |

  @tc:19240
    Scenario Outline: I want to click on the Yes or No buttons on the Weekly spend KPI
        Given I open the <url> url
        When I accept the one trust cookies
        When I type <filter> filters on the location textbox on <url> url
        When I click on the first field of the location dropdown menu on <url> url and <filter> filter
        ...
        Examples:
            ...
            | "/uk" | "bir"  | "Quick service" | "Breakfast, lunch and dinner" | "Weekly spend" | "Yes"       |
            | "/uk" | "bir"  | "Quick service" | "Breakfast, lunch and dinner" | "Weekly spend" | "No"        |
