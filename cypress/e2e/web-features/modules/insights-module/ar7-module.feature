Feature: Top 20% places revenue KPI on the Insights module

  @tc:19232
    Scenario Outline: I want to see Top 20% places revenue KPI on the MMI Public Insights website
        ...
        Examples:
            ...
            | "/uk" | "bir"  | "Quick service" | "Breakfast, lunch and dinner" | "Top 20% places revenue" |

  @tc:19233
    Scenario Outline: I want to see the correct data on the Top 20% places revenue module
        Given I open the <url> url
        When I accept the one trust cookies
        When I type <filter> filters on the location textbox on <url> url
        When I click on the first field of the location dropdown menu on <url> url and <filter> filter
        ...
        Examples:
            ...
            | "/uk" | "bir"  | "Quick service" | "24/7"                | "Top 20% places revenue" |
  ...
  @tc:19234
    Scenario Outline: I want to click on the Yes or No buttons on the Active Food and Drink places KPI
        ...
        Examples:
            ...
            | "/uk" | "bir"  | "Quick service" | "Breakfast, lunch and dinner" | "Top 20% places revenue" | "Yes"       |
            | "/uk" | "bir"  | "Quick service" | "Breakfast, lunch and dinner" | "Top 20% places revenue" | "No"        |